...
/**
 * This class allows us to load the parameters of an experiment from a file. The file must follow
 * the following format:
 *
 * <ul>
 *   <li>Each line contains the value of one parameter.
 *   <li>The lines that start with '#' are ignored.
 *   <li>The integer and doubles must be defined as "parameter_name=value".
 *   <li>The arrays must be defined as "array_name=value_1,value_2,...,value_N".
 * </ul>
 */
