...
/**
 * This interface works as a bridge between the raw file and the DataModel. This interface ensures collaborative
 * filtering ratings separated into two groups: no-test and test. The ratings must be returned in DataSetEntries
 * which structure is conformed by user, item and rating.
 */
