...
class RandomSplitDataSetTest {
    ...
    final private static String filename = "src/test/resources/MockDataset.data";
    final private static long seed = 246;
    final private static double testUsersPercentage = 0.5;
    final private static double testItemsPercentage = 0.5;
