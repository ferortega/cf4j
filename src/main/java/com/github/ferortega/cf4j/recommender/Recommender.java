package com.github.ferortega.cf4j.recommender;
 ...
 * <ul>
 *     <li><i>fit()</i>: fits the recommender according to an instance of a DataModel.</li>
 *     <li><i>predict(userIndex, itemIndex)</i>: computes a rating prediction for a given user and item.</li>
 * </ul>
 */
public abstract class Recommender {
     ...
     * @return Rating prediction for TestItems rated by testUser. Positions of this array overlaps with testItemIndexes
     *          returned by testUser.getTestItemAt(pos)
     */
