...
public abstract class UserSimilarityMetric implements Partible<User> {
	...
	/**
	 * Returns the similarity array of an user. Each position of the array contains the similarity of the user
	 * with the corresponding user at the same position in the array of Users of the DataModel instance.
	 ...
	 * <p>The value returned by this method should be higher the greater the similarity between users.</p>
	 * @param user A user
