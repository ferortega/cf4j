...
public class DataModel implements Serializable {
    ...
    /**
     * This constructor initializes the DataModel with the contents of the given DataSet. Data contained in the DataSet
     * is stored in 4 different arrays: user, testUser, item and testItems. Keeping the main behaviour of the
     * collaborative filtering in mind, any TestUser could have voted both Item or TestItem. In the same way,
     * any testItem could have been voted by a User and TestUser. In the other hand, Users and Items will not have a
     * test part.
     ...
     * @param filePath Path where the file will be loaded, filename and extension should be included in the path.
