...
/**
 * <p>A TestUser extends an User given him or her the following properties:</p>
 * <ul>
 *  <li>Index in the DataModel array which stores test users.</li>
 *  <li>Array of items rated in test by the user.</li>
 * </ul>
...
public class TestUser extends User {
	...
	/**
	 * Adds a new test rating of the test user to an test item. You cannot overwrite an existing rating, otherwise this
