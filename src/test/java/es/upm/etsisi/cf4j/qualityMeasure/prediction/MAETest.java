...
class MAETest {
  ...
  @Test
  void getScore() {
    MAE metric = new MAE(null); // Recommender not needed;
    ...
    assertEquals(2.0, metric.getScore(user, allMinimumPrediction));
    assertEquals(2.0, metric.getScore(user, allMaximumPrediction));
  }
}
