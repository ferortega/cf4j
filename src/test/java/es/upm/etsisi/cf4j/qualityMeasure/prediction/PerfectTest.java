...
class PerfectTest {
  ...
  @Test
  void getScore() {
    Perfect metric = new Perfect(null, 0.5); // Recommender not needed;

    assertEquals(1.0, metric.getScore(user, perfectPrediction));
    assertEquals(0.6666666666666666, metric.getScore(user, slightlyPrefectPrediction));
    assertEquals(0.16666666666666666, metric.getScore(user, allMinimumPrediction));
    assertEquals(0.16666666666666666, metric.getScore(user, allMaximumPrediction));
  }
}
