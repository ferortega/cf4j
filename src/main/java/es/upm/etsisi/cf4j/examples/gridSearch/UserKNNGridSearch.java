...
/**
 * In this example we tune the parameters of UserKNN recommender using the GridSearch tool. Top 5 results with
 * highest Precision score are printed.
 */
public class UserKNNGridSearch {
    ...
    public static void main(String[] args) throws IOException {
        ...
        grid.addParam("metric", new UserSimilarityMetric[]{
                new AdjustedCosine(),
                new CJMSD(),
                new Correlation(),
                new Cosine(),
        ...
        GridSearch gs = new GridSearch(datamodel, grid, UserKNN.class, Precision.class, precisionParams);
        gs.fit();
