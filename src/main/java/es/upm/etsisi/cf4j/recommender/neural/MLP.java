...
public class MLP extends Recommender {
    ...
    public MLP(DataModel datamodel, int numEpochs, double learningRate, int[] layers, long seed) {
        ...
        builder.addLayer("out", new OutputLayer.Builder(LossFunctions.LossFunction.MSE)
                .nIn(layers[i-1])
                .nOut(1)
    ...
    public String toString() {
        ...
        StringBuilder sbuilder = new StringBuilder("MLP(" + "numEpochs=" + this.numEpochs +" learningRate="+this.learningRate+" layers="+layerPrint+")");
